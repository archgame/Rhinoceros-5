...
True Type Font: Enhanced LED Board-7 version 1.0


EULA
-==-
The font Enhanced LED Board-7 is freeware for home using only.
...
Files in enhanced_led_board-7.zip:
       	readme.txt     				this file;
        enhanced_led_board-7.ttf    		regular true type font;
	enhanced_led_board-7_screen.png		preview image.
